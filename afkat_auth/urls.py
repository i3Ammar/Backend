...
urlpatterns = [
    ...
    path(
        "users/<int:pk>/followers/", UserFollowersView.as_view(), name="user_followers"
    ),
    path(
        "users/<int:pk>/following/", UserFollowingView.as_view(), name="user_following"
    ),
]
